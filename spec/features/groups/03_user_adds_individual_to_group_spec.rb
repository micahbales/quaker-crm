...
RSpec.feature "user adds individual to group" , %Q(
  ...
  #     [x] I see the individual show page, with a list of which groups that
  ...
  scenario "user adds individual to 3 groups" do
    ...
    expect(page).to have_content("Groups: #{individual.groups.first.name}, #{individual.groups[1].name}, #{individual.groups.last.name}")
  end
